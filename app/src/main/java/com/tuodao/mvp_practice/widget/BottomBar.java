        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mCurrentPosition == pos) {
                    mOnTabSelectedListener.onTabReselected(pos);
                } else {
                    mOnTabSelectedListener.onTabSelected(pos, mCurrentPosition);
                    tab.setSelected(true);
                    mOnTabSelectedListener.onTabUnSelected(mCurrentPosition);
